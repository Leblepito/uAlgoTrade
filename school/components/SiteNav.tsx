      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20 gap-4">
          ...
          <div className="hidden sm:flex items-center gap-2 sm:gap-4">
            ...
            <a href="https://games.ualgotrade.com" className="px-3 py-2 text-xs sm:text-sm font-semibold text-slate-200 hover:text-white hover:bg-white/5 rounded-lg transition-all">
              Games
            </a>
            {userLabel ? (
        ...
        {mobileMenuOpen ? (
          <div className="sm:hidden border-t border-white/5 py-3 space-y-1">
            ...
            <a
              href="https://games.ualgotrade.com"
              className="block px-4 py-3 text-sm font-semibold text-slate-200 hover:text-white hover:bg-white/5 rounded-lg transition-all"
              onClick={() => setMobileMenuOpen(false)}
            >
              Games
